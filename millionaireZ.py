...
def questions_four_correct_1():
    ...
    'S-sorry' you utter across to your superior. Then like a popped water balloon, 'S-s-sorry everyone', you gush to the entire studio.""")
    time.sleep(1)
    console_slow_type("""
    You wipe the blood from your eye, and see two producers holding bottles, one metal, one glass above their heads menacingly."
    'Got it.' You're on the same page now. No American showboating.""")
    time.sleep(1)
    console_slow_type("""
    Stoic and mild shy bitterness. That's the way.
    British television has existed on atop these pillars for over 6 decades. Old bulldog, new trick... and all that.""")
    time.sleep(1)
    console_slow_type("""
    ...
    The trolley is covered by a white sheet, and is stained - being currently stained by what looks an incredible amount like blood.""")
    time.sleep(1)
...
def questions_seven_correct_1():
    ...
    You watch in horror, while an old man in a lab coat and a teenage boy climb out of the space craft.
...
def questions_nine_correct_1():
    ...
    time.sleep(1)
    console_slow_type("""'Amazing! You have made it to the FINAL ROUND because that answer was correct!' Chris exclaims.
    You downplay the triumph as the audience cheers and claps for your acheivement. Who knew Pokémon knowledge could be worth £500k one day?! 
    """)
...
def questions_nine_correct_2():
    ...
    And you had to go and choose bloody D! D?!
    Oh god, it definitely wasn't the right option. Look at Chris's face. That stupid, smirking face.
    ...
    time.sleep(1)
    console_slow_type("""'Incredible! That was the right answer, which means you have made it to the FINAL ROUND!' Chris claps his hands in amazement.
...
def questions_ten_correct_1():
    ...
    console_slow_type("""You freeze for a minute, but it’s probably just administrative stuff. Maybe it’ll be paid in instalments?
    'Ok, so times are a little hard at ITV right now. I mean, we don’t really expect anyone to win that much to be honest. And no one even really cares about quiz shows anymore, I mean, why did you even bother coming on?'
...
def questions_ten_correct_2():
    console_slow_type("""
    'CONGRATULATIONS' Chris shouts loudly.
    ...
    Can't hurt, there's a million in it for you.     ...which was yours to begin with. 
...
def ready_or_not():
    console_slow_type("""The show runner, obviously not used to such a response remains glazed, save for a twitch in their right eye.
    ...
    if ready_annoyed1 == "N":
        ...
        That last comment threw you a bit - you look puzzled. The show runner read - worse."
        ...
        'What's the hold up. They're ready. You're ready aren't you buddy!'
    ...
    if ready_annoyed2 == "N":
        ...
        'No, how?' you say.
        'Look up there at that sign.' He points high up to your left, and as you follow his finger with your eyes, his clipboard comes striking down out of the dark rendering you unconscious.
        'Bloood...bloody hell' you stammer out as your eyes open and you realise you are slumped on a stool, shocked and blinded by incredibly bright lights.
        """)
    else:
        story_start_game(question_index, f"'Hello and welcome to Who Wantz to be a Millionaire! Today we have {player_name} with us, an aspiring developer, hoping to win big! Let's begin with an easy one!'",chances)
...
def green_room_wrong ():
    ...
    'Look.' Some producer has swivelled you round on your stool. It swivels, that is new.
    ...
    The show isn't live. Come on, shit-for-brains.
    ...
    if response == "Y" or response == "y" or response == "yes" or response == "Yes" or response == "YES":
        ...
        console_slow_type("""'Oh for fuu...' The show runny looks away in disgust. 'You want to go down this road?'""")
        time.sleep(2)
...
def chris_sanity_decline(chances):
    ...
    if (chances == 3):
        ...
        console_slow_type("""\n\t\t\tBAM! Chris has thumped his terminal. 
                        ...
                        You peer over and see that Chris has hit the facade of his screen, exposing ever so slightly, what he had on his screen. 
                        ...
                        Something in his voice tells you this pompous clown may actually mean it. He definitely means it. 
        ...
        console_slow_type ("""\n Chris starts laughing.
                        ...
                        It's caught on - the audience are giggling now too.
                        Within seconds the entire room is bubbling along with the laughter, its infectious as hell.
                        ...
                        'Meet!', Tarrant injects. 'I of course meant meat. Meet and meat.'
                        Worryingly, the idea of meeting you, or at least the mention of it has put some of the crowd in an absolute furore - will you be a star, you think?
...
def die_become_z():
    ...
    time.sleep(1)
    console_slow_type("""
    From behind you, you hear the sharp creak of metal unhinging, and a vicious crackling as the bars holding the now frenzied mob come down.
    ...
    Wanker.
    As the hoard begin to surround every inch of space around you, you aim the entirety of your life's anger skyward and scream.
    ...
    'BLAH!' You think to yourself. That must be it. I'm a zombie.
    And you'd be right. You are the recently reanimated corpse of your former self.
    But look on the bright side, you dumbly think as you watch a fresh faced new contestant be ushered onto the stool ahead of you...
    They look tasty.
    """)
...
def questions_four_incorrect():
    ...
    You lean smugly back in your stool and peer at Tarrant over your nose, full to the brim with blind utter confidence."
    ...
    'I-I-I...' you stammer, unable to speak nor stop your arm, hand and index finger from indicating the exact position of your accomplice!
    ...
    The skeletons have split into two groups, one moving towards Jay - your accomplice, and by day, your coding instructor...
    ...
    time.sleep(1)
    console_slow_type("""Mercifully, one of the skeletons hits on a main artery in your leg, and soon everything fades to black.
    The last thing you see is Chris Tarrant, wreathed in green flame floating over your butchered corpse, caressing the smooth bone of his skeleton children.
    Oh well.
    """)
...
def questions_seven_incorrect():
    ...
    Before you can ask anymore questions, Chris is chaperoned away by a group of showrunners.""")
    time.sleep(1)
    console_slow_type("""
...
def questions_nine_incorrect():
    ...
    By the time you look up, Jay, or whoever they were, had disappeared. You're still wondering what just happened...well, it has been a very odd life since the 2020s, so anything's possible at this rate!""")
    time.sleep(1)
    ...
    console_slow_type(f"""'Welcome back, ladies and gentlemen, to Who Wants to be a Millionaire. Here we have {player_name}, an aspiring developer, who is currently on Question 9, which, if answered correctly, will result in a whopping win of £500k!'
    ...
    'What the fuck was in those sweets?!' you scream, as you try to lift your now paralysed arms to feel your face.
...
def questions_ten_correct3():
    ...
    Adverts run on a monitor nearby.
    'Yeahhh.' You say, with about as much conviction as a goat facing a tiger.
    Clanging behind you. There's something going on behind the scenes, but the house lights aren't up - which is odd on an ad break, but then...
    'OI! Tarrant!'
    ...
    Jeremy lands a devastating right hook on the jaw of the producer, who sprawls across the studio floor.
    'Keep them coming, ITV, I just came to eat meat and punch producers, and I am allll out of meat!'""")
    time.sleep(1)
    console_slow_type("""
    ...
    'Jeremy, calm down, let's chat.' Tarrant has his soothing voice on.
    ...
    You jump up and with the skill of a relay race runner palm off the crude shiv - a blade strapped to a hollow microphone - into Tarrant's hand!
    The gap between the two hosts has closed considerably and just as Clarkson is winding up to strike, Chris fires the blade into his gut.
    ...
    A Public Service Announcement is being broadcast by Amazon, across all channels, and all devices. Everywhere.
...
def questions_ten_correct4():
    ...
    You're working on a function, when you notice your colon key has disappeared.
    ...
    'We loved having you on the show yesterday, but you didn't expect to just leave without us changing your life in some way did you?' 
    ...
    The disappointment of losing a chance to have a million pounds feels like nothing compared to losing your beloved colon button. You realise that your life will definitely never be the same again. 
    """)
...
def story_start_game(question_index, opening_string, chances):
    ...
    console_slow_type(f'\n{question_list[1]}, {question_list[2]}, {question_list[3]}, or {question_list[4]}') #prints options 
    answer = input("""\n
    ...
    if (answer == correct_answer2):
        ...
        quit_check = input("\n You have pressed Q and choosen to exit the game, are you sure you want to quit? [Y/N]   ").capitalize() #checks if the plays wants to quit
        if  (quit_check == "Y"): 
            console_slow_type("\n Chris pulls that surprised face he loves so much, folds his arms and leans back on his stool. 'No-one is keeping you here...' ") 
            game_over()
...
\u001b[0m""")
    ...
    console_slow_type("\n'HEY!'")
    player_name = input("\n'Hey you. What's your name?'    ").capitalize()
    console_slow_type(f"""'Hi {player_name}!' \n'Sorry - its a little crazy here these days'""")
    time.sleep(1)
    ready1 = input("\n'Are you ready?' [Y/N]   ").capitalize()
    if (ready1 == "Y"):
        ...
        console_slow_type("""
        You look back to the man in the chair. \nYou're nerves subside. \nIt's millionaire. You fucking got this.
        ...
        time.sleep(2)
    beckon_forward = input (" Do you go forward? [Y/N]  ").capitalize()
    if beckon_forward == "N":
        ...
        job_desc = input("'is that right?' [Y/N]  ").capitalize()
        if job_desc == "N":
            console_slow_type("""
        ...
        'play nicely now mate, let's not let things get out of hand...' he leans in 'for both of our sakes.'""")
            time.sleep(2)
            console_slow_type("Millionaire music and lasers swirl through the air, giving the previous moment no time to gain any footing your mind.")
...
intro()
time.sleep(2)
story_start_game(question_index, f"\n'So, {player_name}, excited? Good. Let's start with an easy one!'" ,chances)